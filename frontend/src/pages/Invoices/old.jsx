<div
  className="relative flex cursor-pointer flex-col gap-2 rounded-md border border-gray-200 bg-skin-primary px-6 py-6 text-skin-base   dark:border-gray-900 sm:gap-1 md:grid md:grid-cols-[1rem_repeat(10,_1fr)_1rem] md:items-baseline md:justify-center  md:gap-2 md:px-0 md:py-6 "
  aria-hidden="true"
>
  <div className="bg-skin-secondary/90 group absolute inset-0 flex h-full w-full items-center justify-end gap-4 rounded-md px-6 opacity-0 transition-all duration-200 ease-in-out hover:opacity-100">
    <button
      type="button"
