...
function InvoicesControlPanel({ state }) {
  ...
  return (
    <div
      className="  flex h-max flex-col items-center justify-between gap-6  rounded-md  bg-skin-secondary px-6  py-6  text-sm text-skin-base md:flex-row lg:w-[200px] lg:flex-col-reverse 
